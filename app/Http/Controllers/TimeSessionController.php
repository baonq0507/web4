...
class TimeSessionController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('time-sessions.index')
            ->with('success', __('index.time_session_created_successfully'));
    }
    ...
    public function update(Request $request, TimeSession $timeSession)
    {
        ...
        return redirect()->route('time-sessions.index')
            ->with('success', __('index.time_session_updated_successfully'));
    }
    ...
    public function destroy(TimeSession $timeSession)
    {
        ...
        return redirect()->route('time-sessions.index')
            ->with('success', __('index.time_session_deleted_successfully'));
    }
} 