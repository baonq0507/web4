...
<div class="content-wrapper">
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">Thêm VIP Level</h1>
                </div>
                <div class="col-sm-6">
                ...
                <div class="col-md-8">
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title">Thông tin VIP Level</h3>
                        </div>
                        
                        <form method="POST" action="{{ route('admin.vip.store') }}">
                            @csrf
                            <div class="card-body">
                                @if ($errors->any())
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="number" step="0.01" class="form-control @error('min_deposit') is-invalid @enderror" 
                                                   id="min_deposit" name="min_deposit" value="{{ old('min_deposit', 0) }}">
                                            @error('min_deposit')
                                                <span class="invalid-feedback">{{ $message }}</span>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="number" step="0.01" class="form-control @error('max_deposit') is-invalid @enderror" 
                                                   id="max_deposit" name="max_deposit" value="{{ old('max_deposit') }}" 
                        ...
                        <div class="card-body">
                            <div class="vip-preview text-center p-3 border rounded" style="background: linear-gradient(135deg, #667eea 0%, #764ba2 100%);">
                                <div class="vip-badge mb-3">
                                    <span id="preview-badge" class="badge badge-lg px-3 py-2" style="background-color: #FFD700; color: white; font-size: 16px;">
                                        V1
                                    </span>
                                </div>
                                <h4 id="preview-display-name" class="text-white mb-2">Member</h4>
                                <p class="text-light mb-3">
                                    Nạp từ: $<span id="preview-min">0</span>
                                    <span id="preview-max-text"> - $<span id="preview-max">∞</span></span>
                                </p>
